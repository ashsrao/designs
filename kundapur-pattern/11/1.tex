...
\def\petal{
  ...
  .. controls (0.05,0.05) and (0.72,0.72) .. (0,1.17) %
  .. controls (-0.72,0.72) and (-0.05,0.05) .. (0,0) %
}
...
\foreach \angle in {\petalangle,\petalstephint,...,360} {
    ...
    \draw (0:0) -- (\thisangle:0.75);
}

\draw [black, fill=white] (0,0) circle(0.55cm);
\draw [black, fill=white] (0,0) circle(0.28cm);
%\draw [black, fill=white] (0,0) circle(0.34cm);
