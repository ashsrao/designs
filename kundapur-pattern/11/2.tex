...
%  .. controls (0.25,0.25) and (0.66,0.66) .. (0,1.1) %
...
\draw [black, fill=white] (0,0) circle(0.56cm);
\draw [black, fill=white] (0,0) circle(0.42cm);

\draw [black, fill=white] (0,0) circle(0.14cm); 
