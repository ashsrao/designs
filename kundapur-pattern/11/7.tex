...
\def\petal{
  ...
  .. controls (0.15,0.15) and (0.77,0.77) .. (0,1.20) %
  .. controls (-0.77,0.77) and (-0.15,0.15) .. (0,0) %
}
...
\node[regular polygon, draw=white, fill=white, regular polygon sides=\nsides, minimum size=1.38cm] {};
\node[regular polygon, regular polygon sides=\nsides, minimum size=1.5cm] (A) {};
\node[regular polygon, regular polygon sides=\nsides, minimum size=1.35cm] (B) {};
