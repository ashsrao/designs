...
%\draw [black, fill=white] (0,0) circle(0.66cm);
%\draw [black, fill=white] (0,0) circle(0.44cm);
\node[regular polygon, regular polygon sides=\nsides, minimum size=0.88cm] (A) {};
\node[regular polygon, regular polygon sides=\nsides, minimum size=0.77cm] (B) {};
\node[regular polygon, fill=white, white, regular polygon sides=\nsides, minimum size=0.88cm] (A) {};
%\node[regular polygon, fill=white, white, regular polygon sides=\nsides, minimum size=0.66cm] (B) {};
...
\draw [black, fill=white] (0,0) circle(0.18cm);
\draw [black, fill=white] (0,0) circle(0.11cm);
\end{scope}
